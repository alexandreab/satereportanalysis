...
colB = 7
	...
	set output 'RedLizardMetrics_read-write.eps'
	set title 'RedLizard Read and Write Access'
	colAlabel = "Leitura"
	colBlabel = "Escrita"
	...
	set output 'RedLizardMetrics_under-over.eps'
	set title 'RedLizard Under and Over Bound Access'
	colAlabel = "Under"
	colBlabel = "Over"
	...
	set output 'RedLizardMetrics_heap-stack.eps'
	set title 'RedLizard Heap and Stack Allocation'
	colAlabel = "Heap"
	colBlabel = "Stack"
